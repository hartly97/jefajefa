# Build a Soldier CRUD mini-bundle zip with controller, views, partials, and the two Stimulus controllers.
import os, zipfile, textwrap, json, pathlib

root = "/mnt/data/soldier_crud_bundle"
paths = [
    "app/controllers",
    "app/views/soldiers",
    "app/views/citations",
...
# --- SoldiersController (cleaned minimal working version) ---
soldiers_controller = """# app/controllers/soldiers_controller.rb
class SoldiersController < ApplicationController
  ...
  def show
    @soldier = Soldier.includes(:cemetery, :awards, :soldier_medals => :medal, :citations => :source, :categories).find(@soldier.id)
  end
  ...
  def search
    ...
    render json: scope.limit(10).map { |s|
      base = ([s.try(:first_name), s.try(:last_name)].compact.join(" ").presence || s.try(:slug) || "Soldier ##{s.id}")
...
# --- views/soldiers/index.html.erb ---
index_view = """<!-- app/views/soldiers/index.html.erb -->
<h1>Soldiers</h1>
...
# --- views/soldiers/_pager.html.erb ---
pager_partial = """<!-- app/views/soldiers/_pager.html.erb -->
...
# --- views/soldiers/_list.html.erb ---
list_partial = """<!-- app/views/soldiers/_list.html.erb -->
...
# --- views/soldiers/_form.html.erb ---
form_partial = """<!-- app/views/soldiers/_form.html.erb -->
...
# --- views/soldiers/show.html.erb ---
show_view = """<!-- app/views/soldiers/show.html.erb -->
...
# --- views/soldiers/new.html.erb & edit.html.erb ---
new_view = """<!-- app/views/soldiers/new.html.erb -->
<h1>New Soldier</h1>
<%= render "form" %>
"""
edit_view = """<!-- app/views/soldiers/edit.html.erb -->
<h1>Edit Soldier</h1>
<%= render "form" %>
"""

# --- citations/_fields.html.erb (expects Stimulus controllers) ---
citations_fields = """<!-- app/views/citations/_fields.html.erb -->
...
citations_controller_js = """// app/javascript/controllers/citations_controller.js
...
source_picker_js = """// app/javascript/controllers/source_picker_controller.js
import { Controller } from "@hotwired/stimulus"
...
readme = """# Soldier CRUD Mini-Bundle
Includes controller + views + citations fields partial and Stimulus controllers used by the form.

## Install
1) Unzip into your Rails project root (it’s structured under app/).
2) Ensure Stimulus is loaded (import controllers in your `application.js` and include the JS in your layout).
3) Make sure your `routes.rb` has:
```ruby
