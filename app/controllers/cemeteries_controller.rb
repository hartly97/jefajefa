class CemeteriesController < ApplicationController
  ...
  # end
  # def show
  # @involvements = @cemetery.involvements.includes(:participant)  # keep if you use it
...
def show
  ...
  scope = @cemetery.soldiers.by_last_first
  scope = scope.search_name(@q) if @q.present?
  @burials = scope            # no maybe_page
  @burials_count = @cemetery.soldiers.count
end
